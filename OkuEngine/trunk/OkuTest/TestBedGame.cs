...
namespace OkuTest
{
  public class TestBedGame : OkuGame
  {
    ...
    public override void Initialize()
    {
      ...
      int width = (int)OkuData.ActiveScene.Viewport.Width;
      int height = (int)OkuData.ActiveScene.Viewport.Height;
    ...
    public override void Update(float dt)
    {
      ...
      float speed = 200 * dt;
      Vector center = OkuData.ActiveScene.Viewport.Center;
      ...
      speed = dt;
      Vector scale = OkuData.ActiveScene.Viewport.Scale;
      ...
      OkuData.ActiveScene.Viewport.Center = center;
      OkuData.ActiveScene.Viewport.Scale = scale;
    }
    ...
    public override void Render(int pass)
    {
      switch (pass)
      {
        case 0:
          ...
          OkuData.ActiveScene.Viewport.ScreenSpaceMatrix.Transform(_guiText.Vertices.Positions, transformed);
