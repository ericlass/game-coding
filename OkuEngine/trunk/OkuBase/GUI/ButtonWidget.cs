...
namespace OkuBase.GUI
{
  ...
  public class ButtonWidget : Widget
  {
    ...
    public override void Render(Canvas canvas)
    {
      ...
      if (_focused)
        canvas.DrawLines(_focusRect, Container.ColorMap.FontDark, _focusRect.Length, 0.5f, LineMode.PolygonClosed);
    }
