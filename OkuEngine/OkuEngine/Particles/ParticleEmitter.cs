...
namespace OkuEngine.Particles
{
  ...
  public abstract class ParticleEmitter
  {
    ...
    protected float GetRandomAngle()
    {
      ...
      return _angleVariation == 0.0f ? rads : rads + ((float)_rand.NextDouble() * _pi * _angleVariation);
    }
    ...
    {
      return _speedVariation == 0.0f ? _speed : _speed + ((float)_rand.NextDouble() * _speed * _speedVariation);
    }
    ...
    {
      return _lifetimeVariation == 0.0f ? _lifetime : _lifetime + ((float)_rand.NextDouble() * _lifetime * _lifetimeVariation);
    }
    ...
    {
      return _scaleVariation == 0.0f ? _scale : _scale + ((float)_rand.NextDouble() * _scale * _scaleVariation);
    }
