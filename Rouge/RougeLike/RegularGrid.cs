...
namespace OkuEngine.Geometry
{
  ...
  public class RegularGrid
  {
    ...
    public Vector2f GetMinCell()
    {
      return Vector2f.Zero;
    }

    public Vector2f GetMaxCell()
    {
      int x, y;
    ...
    public void GetCellsIntersecting(Rectangle2f box, ref Vector2f min, ref Vector2f max)
    {
      int x, y;
    ...
    public List<Vector2f> GetCellsOnLine(Vector2f start, Vector2f end)
    {
    ...
    /// <returns>A list of indices of all cell the line crosses.</returns>
    public List<Vector2f> GetCellsOnLine(float x1, float y1, float x2, float y2)
    {
      int cx, cy;
